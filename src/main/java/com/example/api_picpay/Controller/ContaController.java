...
public class ContaController {
    ...
    @Operation(summary = "Listar contas", description = "Faz o retorno de todas as contas cadastradas")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Lista as Contas de acordo com o saldo", description = "Lista as contas que o saldo deve ser maior que o saldo passado como parâmetro")
    @ApiResponses(value={
            @ApiResponse(responseCode = "200", description = "Lista de Contas foi retornada com sucesso",
                content = @Content(mediaType = "application/json",
                    schema = @Schema(implementation = Conta.class))),
            @ApiResponse(responseCode = "404", description = "Não foi encontrado",
                    content = @Content(mediaType = "application/json",
    ...
    @Operation(summary = "Listar Pela Diferenca do Limite Especial", description = "Lista pelo range de limite especial passado como parâmetro")
    @ApiResponses(value={
            @ApiResponse(responseCode = "200", description = "Lista de Contas foi retornada com sucesso",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = Conta.class))),
    ...
    public ResponseEntity<?> atualizaConta(@Parameter(description = "Inserir o número da conta do cliente") @PathVariable String numConta, @RequestBody Map<String, Object> valoresAtualizar){
        try{
